...
class _$AuthSessionImpl implements _AuthSession {
  ...
  @override
  String toString() {
    return 'AuthSession(accessToken: $accessToken, refreshToken: $refreshToken, user: $user, accessTokenExpiresAt: $accessTokenExpiresAt, refreshTokenExpiresAt: $refreshTokenExpiresAt, rememberMe: $rememberMe)';
  }
